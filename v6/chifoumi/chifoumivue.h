...
*/
    ...
    //Procédure qui affiche dans une Message Box information le gagnant de la partie, son score et le temps
    void tempsMiseAJours(int);
    //affiche le temps de jeu de la partie
    void miseAJourVariable(QString,QString,QString);
    //Procédure qui met à jours l'affichage en fonction des paramétres saisi par l'utilisateur

public slots:
    //Méthodes SLOTS
    void aProposDe();
    //Procédure qui affiche une Message Box contenant des informations sur l'application (version,date,auteurs)
