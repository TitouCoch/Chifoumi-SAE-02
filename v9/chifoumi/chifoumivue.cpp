    ...
    , ui(new Ui::ChifoumiVue), _laPresentation(p)
{
    ...
    connect(ui->action_resultat, SIGNAL(triggered()), p, SLOT(demandeResultat()));
...
void ChifoumiVue::miseAJour(ChifoumiPresentation::UnEtatJeu etat)
{
    ...
    //Etat résultat
    case ChifoumiPresentation::etatResultat:
